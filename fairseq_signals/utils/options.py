...
from fairseq_signals.utils.utils import csv_str_list, eval_bool, eval_str_dict, eval_str_list
...
def parse_args_and_arch(
    ...
    from fairseq_signals.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY, MODEL_REGISTRY
