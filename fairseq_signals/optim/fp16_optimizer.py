...
import torch
from fairseq_signals import optim
from omegaconf import DictConfig

from .dynamic_loss_scalar import DynamicLossScaler
...
class FP16Optimizer(_FP16OptimizerMixin, optim.Optimizer):
    """
...
class MemoryEfficientFP16Optimizer(
    _MemoryEfficientFP16OptimizerMixin, optim.Optimizer
):
    """
    Wrap an *optimizer* to support FP16 (mixed precision) training.
